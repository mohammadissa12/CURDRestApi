...
def user_directory_path(instance, filename):
    ...
    return 'user_{0}/{1}'.format(instance.userpost.id, filename)
class Images(models.Model):
     
    userpost=models.ForeignKey("UserPost",on_delete=models.CASCADE,related_name='images',max_length=100,null=True)
